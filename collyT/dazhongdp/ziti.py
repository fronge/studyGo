...
# #拿到含有字体的css url
# css_url = re.findall('href="(.*s3plus.*)"',text)
...
fonts = {"address":TTFont("7cc1dac6.woff")}
unicodes = fonts["address"].getGlyphOrder()[2:]
base_dict = {}
...
# 需要替换的字符串
old_code_strs = ["&#xf586;","&#xe977;","&#xebee;","&#xe78f;","&#xeeb7;"]
for code in old_code_strs:
    unicode = 'uni' + code.strip("&#x").strip(";")
    contour_code=hashlib.md5(bytes(str(fonts["address"]['glyf'][unicode].coordinates),encoding='utf-8')).hexdigest()
    print(base_dict[contour_code]) 
