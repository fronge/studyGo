...
var file_hello_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x12, 0x16, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x53, 0x74, 0x72,
	...
	0x12, 0x16, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e,
	0x67, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0x16, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77,
	0x61, 0x79, 0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
...
var file_hello_proto_depIdxs = []int32{
	0, // 0: gateway.RestService.Get:input_type -> gateway.StringMessage
	0, // 1: gateway.RestService.Post:input_type -> gateway.StringMessage
	0, // 2: gateway.RestService.Get:output_type -> gateway.StringMessage
	0, // 3: gateway.RestService.Post:output_type -> gateway.StringMessage
...
func (c *restServiceClient) Get(ctx context.Context, in *StringMessage, opts ...grpc.CallOption) (*StringMessage, error) {
	...
	err := c.cc.Invoke(ctx, "/gateway.RestService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *restServiceClient) Post(ctx context.Context, in *StringMessage, opts ...grpc.CallOption) (*StringMessage, error) {
	out := new(StringMessage)
	err := c.cc.Invoke(ctx, "/gateway.RestService/Post", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _RestService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gateway.RestService/Get",
	}
...
func _RestService_Post_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gateway.RestService/Post",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _RestService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "gateway.RestService",
